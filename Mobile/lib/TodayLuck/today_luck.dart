...
class TodayFortuneView extends StatelessWidget {
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              Text(
                today,
                style: Theme.of(context).textTheme.titleMedium?.copyWith(fontWeight: FontWeight.bold, fontSize: sw * 0.06),
              ),
              ...
              Wrap(
                ...
                children: List<Widget>.from(
                  (fortune['keywords'] as List<dynamic>).map(
                        (word) => Chip(
                      label: Text(word),
                      backgroundColor: isDark ? Colors.teal[700] : Colors.teal[50],
              ...
              Center(
                child: SizedBox(
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      log("GPT에게 더 물어보기 버튼 클릭");
                    },
                    child: Text('GPT에게 더 물어보기', overflow: TextOverflow.ellipsis),
                  ),
                ),
              ),
              SizedBox(height: 20),
  ...
  Widget _buildCategoryCard(BuildContext context, String title, String content) {
    return Padding(
