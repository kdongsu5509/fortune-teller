...
public class AccessLog {
    ...
    public static com.jangpyeong.fortuneteller.v1.fortune.access.domain.AccessLog of(AccessLogRequest dto) {
        return new com.jangpyeong.fortuneteller.v1.fortune.access.domain.AccessLog(
                dto.getMethod(),
                dto.getUri(),
                dto.getQuery(),
                dto.getRequestBody(),
    ...
    public static com.jangpyeong.fortuneteller.v1.fortune.access.domain.AccessLog of(
            AccessLogConsumerCommand.Save save) {
        return new com.jangpyeong.fortuneteller.v1.fortune.access.domain.AccessLog(
                save.getMethod(),
                save.getUri(),
                save.getQuery(),
